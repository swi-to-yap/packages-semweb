...
LIBPL=		$(addprefix $(srcdir)/, \
		rdf_db.pl rdfs.pl rdf_edit.pl rdf_litindex.pl \
		rdf_persistency.pl rdf_turtle.pl rdf_cache.pl \
		rdf_http_plugin.pl rdf_zlib_plugin.pl rdf_portray.pl \
		rdf_compare.pl rdf_turtle_write.pl turtle.pl \
		rdf_library.pl sparql_client.pl rdf_ntriples.pl \
		)

DATA=		$(addprefix $(srcdir)/, \
